/**
 * Chatwoot Webhooks API Route
 * Migrated from orchestrator - handles all Chatwoot webhook events
 */
...
import { chatwootWebhookSchema } from '@/app/lib/validation/validation';
...
// ============================================================================
// POST /api/v1/webhooks/chatwoot - Receive Chatwoot webhooks
// ============================================================================

export async function POST(request: NextRequest) {
  try {
    const payload = await validateRequestBody(request, chatwootWebhookSchema);
...
async function handleWebwidgetTriggered(payload: any) {
  ...
  const tenantId = 'mock-tenant-id'; // TODO: Get from payload
