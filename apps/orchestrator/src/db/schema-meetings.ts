...
export const caseStatusEnum = pgEnum('case_status', ['open', 'in-progress', 'waiting', 'resolved', 'closed']);
...
export const todoStatusEnum = pgEnum('todo_status', ['not-started', 'in-progress', 'completed', 'cancelled']);
